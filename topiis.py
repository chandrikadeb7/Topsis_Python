...
def main():
    # Argument check: args = 6
    if len(sys.argv) != 6:
        args_check = "greater" if (len(sys.argv) > 6) else "less"
        print("Error: Number of arguments is ", args_check, " than 6")
    ...
    # File extension check
        ...
        try:
            ...
            print("ERROR: Either the weights contains erroneous values or not comma sperated")
            exit(1)
